...
object RichLogger {
  ...
  def d(msg: String, e: Throwable)(implicit tag: LogcatTag) =
    Log.d(tag.tag, msg, e)
  def d(msg: String, args: Any*)(implicit tag: LogcatTag) =
    Log.d(tag.tag, msg format(args:_*))
  def v(msg: String)(implicit tag: LogcatTag) = Log.v(tag.tag, msg)
  def v(msg: String, e: Throwable)(implicit tag: LogcatTag) =
    Log.v(tag.tag, msg, e)
  ...
  def i(msg: String, e: Throwable)(implicit tag: LogcatTag) =
    Log.i(tag.tag, msg, e)
  ...
  def w(msg: String, e: Throwable)(implicit tag: LogcatTag) =
    Log.w(tag.tag, msg, e)
  ...
  def e(msg: String, e: Throwable)(implicit tag: LogcatTag) =
    Log.e(tag.tag, msg, e)
